...
sudo apt-get update
sudo apt-get install -y python3 python3-tk python3-gi gir1.2-gstreamer-1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly python3-dev python3-setuptools python3-wheel python3-pip libudev-dev
